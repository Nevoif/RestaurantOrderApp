    ...
    public class LocalizationService
    {
        ...
        private string GetTurkish(string key)
        {
            return key switch
            {
                ...
                "TotalLabel" => "Toplam",
                "PrintButton" => "Yazdır",
                "PrintReceiptButton" => "Fiş Yazdır",
                "CheckoutButton" => "Ödeme Al",
                "CheckoutCreditCardButton" => "Kredi Kartı",
                "CheckoutCashButton" => "Nakit",
                "CheckoutPackageOrderButton" => "Paket Sipariş",
                "DeleteButton" => "Sil",
                ...
                "NetworkPrinterIPLabel" => "Ağ Yazıcısı IP Adresi",
                "NetworkPrinterPortLabel" => "Ağ Yazıcısı Portu",
